...
For the CNN we use one hot encoding to produce a vector of 10 values per sample, with a one on the class.
...
Takes about 3 minuts with 40 cores and 18 GB of RAM.
